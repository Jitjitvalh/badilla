...
if (empty($loginInput) || empty($password)) {
    echo json_encode(['status' => 'error', 'message' => 'Kinahanglan nga sabtan ang Username/Gmail kag Password (Please enter both username/Gmail and password).']);
    exit;
}
...
try {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        echo json_encode(['status' => 'error', 'message' => 'Sala ang Username/Gmail ukon Password (Invalid credentials).']);
    }
