...
try {
    ...
    $userCols = ['email VARCHAR(100) DEFAULT NULL', 'high_score INT DEFAULT 0', 'total_score INT DEFAULT 0', 'games_played INT DEFAULT 0', 'last_active TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'];
